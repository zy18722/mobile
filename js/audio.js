...
;(function($, window, document, undefined) {
	...
	if (!$('#ppq-audio-player-style').length) {
		var style = '<style id="ppq-audio-player-style" type="text/css">\
			...
			.ppq-audio-player .play-pause-btn .play-pause-icon{position:relative;display:block;width:47px;height:47px;border:2px solid #468f67;border-radius:100%;background-color:#fff}\
